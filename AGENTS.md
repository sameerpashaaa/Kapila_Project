...
This project is indexed by GitNexus as **Kapila_Project** (1425 symbols, 3201 relationships, 113 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
