...
This project is indexed by GitNexus as **Kapila_Project** (1546 symbols, 3539 relationships, 123 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
